// ==UserScript==
// @name         Khamsat Categories Enhanced v3.0
// @namespace    https://khamsat.com/
// @version      3.0
// @description  تصنيف طلبات خمسات محسن مع دقة عالية
// @author       Enhanced Version v3.0
...
(function() {
    ...
    const categories = {
        تصميم: {
            exact: ['تصميم', 'مصمم', 'مصممة', 'ديزاينر', 'جرافيك', 'شعار', 'لوغو', 'لوجو', 'هوية بصرية', 'ui', 'ux'],
            high: ['بوست', 'بوستات', 'منشورات', 'بنر', 'بنرات', 'غلاف', 'بروشور', 'كتالوج', 'انفوجرافيك', 'بروفايل شركة'],
            medium: ['كانفا', 'canva', 'فوتوشوب', 'اليستريتور', 'فيجما', 'figma', 'بطاقة'],
            low: ['صور', 'ثمبنيل', 'thumbnail', 'مصغرة', 'سوشيال ميديا'],
            icon: 'fa-palette', color: '#17a2b8'
        },
        برمجة: {
            exact: ['برمجة', 'تطوير', 'مبرمج', 'مطور', 'developer', 'موقع', 'مواقع', 'تطبيق', 'تطبيقات', 'app'],
            high: ['بوت', 'bot', 'سكريبت', 'script', 'api', 'ووردبريس', 'wordpress', 'اندرويد', 'android', 'ios', 'صفحة هبوط'],
            medium: ['php', 'javascript', 'python', 'flutter', 'laravel', 'nodejs', 'react', 'html', 'css', 'متجر الكتروني'],
            low: ['ويب', 'web', 'قاعدة بيانات', 'database', 'سيرفر', 'استضافة'],
            icon: 'fa-code', color: '#28a745'
        },
        تسويق: {
            exact: ['تسويق', 'مسوق', 'اعلان', 'اعلانات', 'ممول', 'حملة', 'حملات', 'ادسنس', 'adsense', 'seo', 'تحسين محركات'],
            high: ['فيسبوك', 'facebook', 'انستقرام', 'instagram', 'تيك توك', 'tiktok', 'سناب شات', 'جوجل ادز', 'ظهور في جوجل'],
            medium: ['ادارة حسابات', 'سوشيال ميديا', 'ترويج', 'نشر', 'تفاعل', 'متابعين', 'استشارة تسويقية', 'خطة تسويق'],
            low: ['براند', 'brand', 'مبيعات', 'sales', 'استراتيجية', 'تحليل', 'analytics'],
            icon: 'fa-bullhorn', color: '#ffc107'
        },
        كتابة: {
            exact: ['كتابة', 'كاتب', 'كاتبة', 'محتوى', 'مقال', 'مقالات', 'ترجمة', 'مترجم', 'تأليف', 'سيرة ذاتية', 'cv'],
            high: ['تفريغ', 'تدقيق', 'تحرير', 'صياغة', 'تلخيص', 'ملخص', 'copywriting', 'كتابة محتوى'],
            medium: ['نص', 'نصوص', 'سيناريو', 'بحث', 'بحوث', 'أكاديمي', 'مراجعة'],
            low: ['مدونة', 'blog', 'محرر', 'editor', 'وصف منتجات'],
            icon: 'fa-pen', color: '#6610f2'
        },
        فيديو: {
            exact: ['فيديو', 'فيديوهات', 'مونتاج', 'مونتير', 'تحرير فيديو', 'انيميشن', 'animation'],
            high: ['موشن جرافيك', 'motion graphics', 'موشن', 'انترو', 'intro', 'ريلز', 'reels', 'شورت', 'shorts'],
            medium: ['اخراج', 'تصوير', 'مقطع', 'كليب', 'clip', 'تعديل', 'edit'],
            low: ['يوتيوب', 'youtube', 'تيكتوك', 'اعلان مصور', 'برومو', 'promo'],
            icon: 'fa-video', color: '#dc3545'
        },
        صوتيات: {
            exact: ['صوت', 'صوتي', 'تعليق صوتي', 'فويس', 'voice', 'فويس اوفر', 'معلق', 'تفريغ صوتي'],
            high: ['موسيقى', 'music', 'تلحين', 'اغنية', 'انشودة', 'دبلجة', 'dubbing', 'بودكاست', 'podcast'],
            medium: ['هندسة صوت', 'audio', 'تسجيل', 'recording', 'اذاعة', 'معلق صوتي'],
            low: ['ميكس', 'mix', 'ماسترينغ', 'نطق', 'لهجة'],
            icon: 'fa-microphone', color: '#FF80AB'
        },
        بيانات: {
            exact: ['بيانات', 'ادخال بيانات', 'data entry', 'اكسل', 'excel', 'جدول', 'تحويل ملف', 'pdf to word', 'pdf الى word'],
            high: ['تحليل بيانات', 'جمع بيانات', 'scraping', 'تحويل', 'استخراج', 'تنسيق ملف', 'ملف اكسل', 'استخراج بيانات'],
            medium: ['pdf', 'csv', 'جوجل شيت', 'google sheets', 'قاعدة بيانات', 'تحويل صور', 'معالجة بيانات'],
            low: ['تنسيق', 'formatting', 'دمج', 'تصدير', 'export'],
            icon: 'fa-database', color: '#FF6347'
        },
        'خدمات رقمية': {
            exact: ['خدمة عملاء', 'مساعد افتراضي', 'مساعد شخصي', 'سكرتير', 'سكرتيرة', 'خدمات عملاء'],
            high: ['ادارة حسابات', 'نشر اعلانات', 'رد على العملاء', 'support', 'خدمة زبائن'],
            medium: ['تشغيل', 'ادارة صفحات', 'متابعة', 'رد', 'تواصل'],
            low: ['عن بعد', 'remote', 'اونلاين', 'افتراضي', 'virtual'],
            icon: 'fa-headset', color: '#6f42c1'
        },
        استشارات: {
            exact: ['استشارة', 'استشاري', 'مستشار', 'consulting', 'قانونية', 'محامي', 'قانوني', 'استشارة قانونية'],
            high: ['legal', 'نفسية', 'دراسة جدوى', 'خطة عمل', 'business plan', 'خبير'],
            medium: ['تحليل', 'تقييم', 'مراجعة', 'تجارية', 'مالية', 'استشارات'],
            low: ['شخصية', 'حياتية', 'مهنية', 'تطوير الذات'],
            icon: 'fa-user-tie', color: '#e83e8c'
        },
        'خدمات تقنية': {
            exact: ['صيانة', 'اصلاح', 'حل مشكلة', 'مشاكل تقنية', 'دعم تقني', 'مشكل', 'دعم فني', 'مشكلة برمجية'],
            high: ['رفع تطبيق', 'نشر تطبيق', 'اعداد', 'تثبيت', 'install', 'setup', 'تكوين', 'اعداد تقني'],
        ...
        تعليم: {
            exact: ['تعليم', 'تدريب', 'مدرس', 'teacher', 'معلم', 'معلمة', 'استاذ', 'مدرب', 'دروس', 'تدريس', 'شرح'],
            high: ['كورس', 'course', 'دورة', 'دورات', 'تأسيس طالب', 'دروس خصوصية', 'حصص', 'لغة انجليزية'],
            medium: ['واجب', 'منصة تعليمية', 'اختبار', 'test', 'امتحان', 'exam', 'منهج', 'شرح مادة'],
            low: ['قرآن', 'quran', 'آيلتس', 'ielts', 'english', 'خصوصي', 'تعليمي'],
            icon: 'fa-chalkboard-teacher', color: '#FA8072'
        },
        أعمال: {
            exact: ['اعمال', 'business', 'ادارة', 'management', 'محاسبة', 'accounting', 'مالية', 'محاسب', 'حسابات'],
            high: ['موارد بشرية', 'hr', 'وظائف', 'jobs', 'توظيف', 'موظف', 'ادارة مالية', 'حساب الأداء'],
            medium: ['مشروع', 'project', 'تمويل', 'مبيعات', 'sales', 'تجارة', 'commerce'],
    ...
    const classifyText = (text) => {
        ...
        const rescuePatterns = {
            'محامي|قانوني|استشارة قانونية': 'استشارات',
            'صفحة هبوط|landing page': 'برمجة',
            'تحويل ملف|pdf to word|pdf الى word': 'بيانات',
            'معلم|مدرس|استاذ|تدريس': 'تعليم',
            'محاسب|محاسبة|حسابات مالية': 'أعمال',
            'دعم فني|حل مشكلة|مشكل تقني': 'خدمات تقنية',
            'بروفايل شركة|ملف شركة': 'تصميم'
        };

        for (const [pattern, category] of Object.entries(rescuePatterns)) {
            if (pattern.split('|').some(keyword => normalizedText.includes(keyword))) {
                scores[category] += 20;
            }
        }
        ...
        if (/موشن جرافيك|motion graphics/.test(normalizedText)) {
            scores['فيديو'] += 15; scores['تصميم'] += 8;
        }
        if (/تفريغ.*صوتي|تفريغ.*فيديو/.test(normalizedText)) {
            scores['صوتيات'] += 15; scores['كتابة'] += 5;
        }
        if (/seo|ادسنس|adsense|تحسين محركات|ظهور.*جوجل/.test(normalizedText)) {
            scores['تسويق'] += 15;
        }
        ...
        const threshold = Math.max(10, sortedScores[0]?.[1] * 0.35 || 0);
